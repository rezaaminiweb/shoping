...
const Product = (props) => {
    ...
    return (
        ...
        productlist.slice(0, Count).map((item, index) => {
                    ...
                    <div className='w-full font-snapFoodLight sm:w-[50%] lg:w-[25%] px-5 group' key={item.id}>
                        ...
                        <figure className=' relative'>
                            <Link href={'/product/'+item.id+'/'+item.productName}>
                                {item.sale && (
                                    <div className="">
                                        <div className="absolute z-50 w-7 h-10 bg-[#BC8246]  top-0   after:w-[50%] after:h-3 after:clip-path-polygon-[0%_0%,_100%_0%,_100%_100%] after:bg-[#BC8246] after:z-30 after:top-[99%] after:absolute after:flex after:right-0 before:bg-[#BC8246] before:left-0 before:top-[99%] before:flex before:absolute before:w-[50%] before:h-3 before:z-30 before:clip-path-polygon-[0%_0%,_100%_0%,_0%_100%] "  >
